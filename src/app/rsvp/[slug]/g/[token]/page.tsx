...
import { getGuestIdFromRsvpToken } from "@/lib/actions/rsvp";
...
export default async function PersonalRsvpPage({
  ...
  const guestId = await getGuestIdFromRsvpToken(slug, token);
  if (!guestId) notFound();
  ...
  return (
    <div className="flex flex-1 flex-col items-center bg-background px-6 py-16">
      <div className="w-full max-w-lg">
        ...
        <RsvpFlow weddingSlug={slug} initialGuestId={guestId} />
        {wedding.tier === "FREE" && (
